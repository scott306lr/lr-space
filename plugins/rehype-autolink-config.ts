...
export const autolinkConfig: Options = {
  properties: { class: 'w-8 h-6 flex align-baseline items-center opacity-0 group-hover:opacity-100' },
  behavior: 'after',
  group: () => h('div', { tabIndex: -1, class: 'group -ml-8 flex flex-row-reverse justify-end items-baseline' }),
